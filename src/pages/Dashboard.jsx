...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] py-6 sm:py-12 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="relative inline-block">
            ...
            <h2 className="relative text-3xl sm:text-5xl md:text-6xl font-black">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-slate-900 dark:bg-slate-800 rounded-2xl sm:rounded-3xl border-2 border-slate-700 dark:border-slate-600 p-5 sm:p-8 shadow-2xl">
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6 sm:mb-8">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-xl">
            ...
            <div className="flex items-baseline gap-3 mb-6 sm:mb-8">
              <span className="text-5xl sm:text-8xl font-black text-white">
                {bestScore?.wpm || 0}
              </span>
              <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <div className="group/stat relative overflow-hidden bg-gradient-to-br from-emerald-500 to-teal-600 p-4 sm:p-5 rounded-xl sm:rounded-2xl transform hover:scale-105 transition-all">
              ...
              <div className="group/stat relative overflow-hidden bg-gradient-to-br from-purple-500 to-pink-600 p-4 sm:p-5 rounded-xl sm:rounded-2xl transform hover:scale-105 transition-all">
                <div className="absolute inset-0 bg-black/10 group-hover/stat:bg-black/0 transition-colors"></div>
                <div className="relative">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-2xl sm:text-4xl font-black text-white capitalize">
                    {bestScore?.difficulty || "-"}
                  </p>
                </div>
              </div>

              <div className="group/stat relative overflow-hidden bg-gradient-to-br from-cyan-500 to-blue-600 p-4 sm:p-5 rounded-xl sm:rounded-2xl transform hover:scale-105 transition-all">
                <div className="absolute inset-0 bg-black/10 group-hover/stat:bg-black/0 transition-colors"></div>
                <div className="relative">
                  <div className="flex items-center gap-2 mb-2">
        ...
        {/* Motivational Card */}
        <div className="bg-gradient-to-br from-cyan-500 to-blue-600 p-5 sm:p-8 rounded-2xl sm:rounded-3xl shadow-2xl">
