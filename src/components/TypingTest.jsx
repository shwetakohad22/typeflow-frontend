...
const TypingTest = ({
  ...
  useEffect(() => {
    if (containerRef.current) {
      ...
      const targetOffset =
        activeCharLeft - containerWidth / 2 + activeCharWidth / 2;
      ...
      if (index < userInput.length) {
        className +=
          userInput[index] === char
            ...
            : "text-red-500 dark:text-red-400 bg-red-500/10 dark:bg-red-500/15 rounded-sm"; // Incorrect
      } else {
        className += "text-gray-400 dark:text-gray-400"; // Untyped
      }
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          // Correct.
        >
          <div ref={containerRef} className="flex items-center relative py-3">
